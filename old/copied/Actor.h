...
Actor::Actor(int _x, int _y, int _maxHP, int _STR, int _VIT, STATE _state, DIRECTION _dir)
:x(_x), y(_y), maxHP(_maxHP), nowHP(_maxHP), STR(_STR), VIT(_VIT), mState(_state), mDir(_dir)
{
}
